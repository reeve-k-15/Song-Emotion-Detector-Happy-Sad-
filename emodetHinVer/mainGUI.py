...
#Config window
root = tk.Tk()
root.title("AI EMOTION PREDICTER")
...
#Title label
status = tk.StringVar()
status.set("Is It Emotional ?	[Hindi Version]")
wtjc = tk.Label(root,textvariable=status,font=("Cambria", 22))
...
browse.grid(row=1,column=3,padx=5,pady=20,sticky="news")

#Analyse button
analyse = tk.Button(root,text="Analyse",bg="black",fg="white",command = lambda: analyseFunc(wtjc))
